...
#### 프론트엔드 개발
- [x] 스크립트 라이브러리 메인 페이지 (`ScriptLibrary.tsx`)
- [x] 스크립트 에디터 컴포넌트 (CodeMirror 기반)
- [x] 스크립트 카테고리 트리 네비게이션
- [x] 스크립트 검색 및 필터 인터페이스
- [x] 스크립트 실행 결과 표시 UI
- [x] 스크립트 공유 설정 UI
- [x] 스크립트 즐겨찾기 기능
- [x] 스크립트 템플릿 갤러리
...
#### 프론트엔드 개발
- [x] 배치 실행 인터페이스 (`BatchExecution.tsx`)
- [x] 서버 선택 UI (체크박스, 그룹 선택)
- [x] 명령어 입력 및 검증 UI
- [x] 실행 진행상황 표시 (프로그레스 바)
- [x] 서버별 실행 결과 표시
- [x] 실패한 작업 재시도 UI
- [x] 배치 실행 템플릿 저장 기능
