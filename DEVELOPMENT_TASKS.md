...
- [ ] 서비스 상태별 분류 UI (활성, 비활성, 실패)
- [ ] 서비스 카드 컴포넌트 구현 (`ServiceCard.tsx`)
- [ ] 서비스 제어 버튼 UI (시작, 중지, 재시작)
- [ ] 서비스 상태 표시 아이콘 및 색상 시스템
- [ ] 서비스 검색 및 필터링 기능
- [ ] 서비스 로그 뷰어 모달 구현
- [ ] 서비스 관리 권한 확인 UI
...
#### 백엔드 API 개발
- [ ] 네트워크 연결 조회 API 구현 (`GET /api/monitoring/network/:hostId`)
- [ ] `netstat -tulpn` 명령어 결과 파싱
- [ ] 리스닝 포트 정보 조회 API 구현
- [ ] 네트워크 통계 정보 수집 API 구현
- [ ] 방화벽 상태 조회 기능 구현
- [ ] 네트워크 모니터링 데이터 타입 정의
- [ ] 네트워크 API 단위 테스트 작성

#### 프론트엔드 UI 개발
- [ ] 네트워크 모니터링 컴포넌트 생성 (`NetworkMonitor.tsx`)
- [ ] 활성 연결 테이블 UI 구현
- [ ] 리스닝 포트 표시 UI 구현
- [ ] 네트워크 통계 대시보드 UI
- [ ] 포트 상태 시각화 (열림/닫힘)
...
#### 백엔드 API 개발
- [ ] 디스크 사용량 조회 API 구현 (`GET /api/monitoring/disk/:hostId`)
- [ ] `du -sh` 명령어 결과 파싱 함수
- [ ] 디렉토리 크기 정보 수집 함수
- [ ] 파일시스템 정보 조회 API
- [ ] 큰 파일 검색 API 구현
