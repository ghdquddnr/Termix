...
#### 백엔드 API 개발
- [ ] SSH 명령어 실행을 위한 공통 유틸리티 함수 작성
- [ ] 프로세스 목록 조회 API 엔드포인트 구현 (`GET /api/monitoring/processes/:hostId`)
- [ ] `ps aux` 명령어 결과 파싱 함수 구현
- [ ] 프로세스 정보 타입 정의 (TypeScript 인터페이스)
- [ ] **테스트**: 기본 프로세스 API 테스트 수행
